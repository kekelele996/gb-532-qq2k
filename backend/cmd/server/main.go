...
func main() {
	...
	taskRepository := repository.NewResurveyTaskRepository(db)
	...
	taskService := service.NewResurveyTaskService(taskRepository, coverageRepository, auditService)
	...
	handlers := router.Handlers{
		...
		Coverage: handler.NewCoverageGapHandler(coverageService), Task: handler.NewResurveyTaskHandler(taskService), Audit: handler.NewAuditHandler(auditService),
	}
